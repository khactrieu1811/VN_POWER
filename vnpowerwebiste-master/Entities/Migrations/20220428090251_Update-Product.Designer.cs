...
namespace Entities.Migrations
{
    ...
    [Migration("20220428090251_Update-Product")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Entities.CategoryProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime?>("RegisterEndDateEvent")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Entities.Entities.CategoryProduct", b =>
                {
                    b.HasOne("Entities.Entities.CategoryProduct", "CategoryProductNavigation")
                        .WithMany("InverseCategoryProductNavigation")
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("Entities.Entities.Product", b =>
                {
                    b.HasOne("Entities.Entities.CategoryProduct", "CategoryProduct")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
